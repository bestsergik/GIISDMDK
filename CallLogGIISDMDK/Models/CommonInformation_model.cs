...
namespace CallLogGIISDMDK.Models
{
    class CommonInformation_model : INotifyPropertyChanged
    {
        ...
        private void FillGeneralInformation()
        {
            ...
            reductions.Add("ИС АКД");
            reductions.Add("информационная система формирования и обработки актов государственного контроля драгоценных камней и металлов.");
            ...
            reductions.Add("ЕГРЮЛ");
            reductions.Add("единый государственный реестр юридических лиц.");
